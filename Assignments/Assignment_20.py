    ...
    if (account_number in range(1000,2000)):
        if (account_balance >= 100000):
            if (salary > 25000 and salary <= 50000 and loan_type == "Car"):
                ...
                if ((customer_emi_expected <= 60 and customer_emi_expected > 36) and (loan_amount_expected <= 6000000 and loan_amount_expected > 500000)):
                ...
                if ((customer_emi_expected <= 84 and customer_emi_expected > 60) and (
                        loan_amount_expected <= 7500000 and loan_amount_expected > 600000)):
